  ...
  return (
    <SafeAreaView className="flex max-h-full flex-1">
      ...
      <ScrollView className="mx-auto max-w-7xl flex-1 p-8 px-6 lg:px-8">
        ...
        <P className="my-4 font-semibold">SECTION 1 - ONLINE STORE TERMS</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 2 - GENERAL CONDITIONS</P>
        <P>
        ...
        <P>
          We are not responsible if information made available on our apps is
          not accurate, complete or current. The material on our apps is
          ...
          information. Any reliance on the material on our apps is at your own
          risk.
        </P>
        <P>
          Our apps may contain certain historical information. Historical
          information, necessarily, is not current and is provided for your
          reference only. We reserve the right to modify the contents contents
          of these apps at any time, but we have no obligation to update any
          information on our apps. You agree that it is your responsibility to
          monitor changes to our apps.
        </P>
        <P className="my-4 font-semibold">
        ...
        <P>
          Certain services may be available exclusively online through the
          website. These services may have limited quantities and are subject to
          return or exchange only according to our policy.
        </P>
        <P>
          We have made every effort to display as accurately as possible the
          images of our products that appear at the stores. We cannot guarantee
          that your computer monitors display of any color will be accurate.
        </P>
        <P>
          ...
          limit the quantities of any service that we offer. All descriptions of
        ...
        <P>
          We reserve the right to refuse any service you subscribe with us. We
        ...
        <P className="my-4 font-semibold">SECTION 7 - OPTIONAL TOOLS</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 8 - THIRD-PARTY LINKS</P>
        <P>
        ...
        <P>
          ...
          carefully the third-partys policies and practices and make sure you
        ...
        <P>
          ...
          or otherwise (collectively, comments), you agree that we may, at any
          ...
          We are and shall be under no obligation (1) to maintain any comments
          in confidence (2) to pay compensation for any comments or (3) to
        ...
        <P className="my-4 font-semibold">SECTION 10 - PERSONAL INFORMATION</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 12 - PROHIBITED USES</P>
        <P>
        ...
        <P>
          In no case shall Skyhitz, our directors, officers, employees,
        ...
        <P className="my-4 font-semibold">SECTION 14 - INDEMNIFICATION</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 15 - SEVERABILITY</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 16 - TERMINATION</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 17 - ENTIRE AGREEMENT</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 18 - GOVERNING LAW</P>
        <P>
        ...
        <P className="my-4 font-semibold">SECTION 20 - CONTACT INFORMATION</P>
        <P>
