  ...
  return (
    <>
      <Pressable onPress={() => playEntry(entry, [entry])}>
        <View className="border-grey min-h-30 flex w-full border-b border-solid p-2 pb-2 md:min-h-10 md:flex-row md:items-center md:border-b-0">
          ...
          <View className="my-2 flex flex-row items-center md:mt-0">
            <Button
              ...
              disabled={loading}
            />
            <Button text="Details" onPress={() => push(`/beat/${entry.id}`)} />
          </View>
        </View>
      </Pressable>
      {/* <WalletConnectModal
