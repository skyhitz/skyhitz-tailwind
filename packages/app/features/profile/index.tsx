...
import { ProfileHeader, SocialLinks } from 'app/features/profile/ProfileHeader'
...
import { ProfileRow } from 'app/features/profile/profileRow'
      ...
      <View className="ml-2 mt-8 flex">
        <View className="flex-row items-center justify-between">
          ...
          <SocialLinks
            ...
            profileUrl={`${Config.APP_URL}/collector/${user.id}`}
          />
        </View>
